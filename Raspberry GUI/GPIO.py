...
def check_led_status(heure_on, heure_off):
...
while True:
    ...
    print("LED 1:", check_led_status(heure_on_led1, heure_off_led1))
    print("LED 2:", check_led_status(heure_on_led2, heure_off_led2))
    print("LED 3:", check_led_status(heure_on_led3, heure_off_led3))
